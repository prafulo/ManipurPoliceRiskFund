...
export function Header() {
  ...
  return (
    <header className="flex h-16 items-center gap-4 border-b bg-card px-4 md:px-6 sticky top-0 z-30 print:hidden">
      <Sheet>
      ...
      <div className="flex w-full items-center gap-4 md:ml-auto md:gap-2 lg:gap-4 print:hidden">
